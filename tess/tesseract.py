...
class Tess:
    ...
    AUTO seems to be the most accurate, WHILE RAW_LINE and SINGLE_BLOCK seems to be the fastest (inaccurate).
    ...
    def __init__(self):
        ...
        self.t = PyTessBaseAPI(psm=PSM.AUTO, oem=OEM.LSTM_ONLY, lang="eng")
